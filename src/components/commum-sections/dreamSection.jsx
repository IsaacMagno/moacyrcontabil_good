...
const DreamSection = () => {
  return (
    <section className="flex flex-col w-full pt-6 items-center gap-6 bg-[#323231] lg:flex-row lg:justify-between lg:pl-20 lg:pt-0 xlg:pl-32">
      ...
      <div className="relative w-full h-[21.75rem] lg:w-[32rem] lg:h-[31rem] lmd:w-[45rem] lmd:h-[43rem] xlg:w-[60rem] xlg:h-[58rem]">
        <Image src={"/people happy.png"} fill />
      </div>
    </section>
  );
};
