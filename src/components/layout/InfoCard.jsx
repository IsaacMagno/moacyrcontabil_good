...
const InfoCard = ({ serviceSectionText }) => {
  return (
    <div className="min-h-screen flex flex-col lg:flex-row justify-center lg:items-center gap-5">
      {serviceSectionText.map((section) => {
        const key = Object.keys(section)[0];
        return (
          <section
            key={key}
            className="inline-flex items-center p-5 xlg:p-10  mx-10 h-[45vh] lg:h-[40vh] lg:w-[40vh] lmd:h-[50vh] lmd:w-[50vh] justify-center rounded-lg lg:px-4 lg:py-6 lg:rounded-[1.25rem] hover:bg-[#F6BE25] group relative cursor-pointer"
          >
