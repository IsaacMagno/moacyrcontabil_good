...
const LocationSection = () => {
  ...
  return (
    <section className="flex flex-col w-full px-4 py-6 items-start gap-6 bg-[#323231] lg:px-20 lg:py-16 lg:gap-6 lmd:py-32 lmd:gap-10 xlg:px-[16rem] xlg:py-[11.5rem]">
      <section>
